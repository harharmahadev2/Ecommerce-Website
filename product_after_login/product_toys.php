      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="../index/index_after_login.php">Home</a>
            </li>
    ...
    <div class="container mg-4">
      <div class="row">
          ...
          <!-- <img src="..." class="card-img-top" alt="..."> -->
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../img/cube1.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="../img/cube2.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="../img/cube3.jpeg" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <div class="card-body">
          ...
          <p class="card-text">Cubelelo MoYu MeiLong 3C 3x3 Stickerless Cube Speedcube Magic Cube Puzzle Game Toy</p>
          <hr>
          <p>Price : 200</p>
        ...
        <div class="card col-lg-4 mx-auto my-5" style="width: 18rem;">
          <!-- <img src="..." class="card-img-top" alt="..."> -->
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../img/car1.jpeg" class="d-block w-100 my-4" alt="...">
              </div>
              <div class="carousel-item">
                <img src="../img/car2.jpeg" class="d-block w-100 my-5" alt="...">
              </div>
              <div class="carousel-item">
                <img src="../img/car3.jpeg" class="d-block w-100 my-5" alt="...">
              </div>
            </div>
        ...
        <div class="card-body">
          ...
          <p class="card-text">Jada 1:32 Scale 1999 Ford F-150 Lightning Diecast Car Toys for Kids Age 8 Years+</p>
          <hr>
          <p>Price : 650</p>
          <a href="#" class="btn btn-primary">Add to Cart</a>
        </div>
