...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../style/stylesheet_product_login.css">
    ...
    <div class="container mg-4">
      ...
      mysqli_select_db($connect, 'product');  
                ...
                {   
                     ...
                     {  
                ?>
                <!-- insertion of product into cart table  -->
              <div class="col-lg-3">
                ...
                <form action="../cart/manage_cart.php" method="POST">
                  <div class="card col-lg-4 mx-auto my-5" style="width: 18rem;">
                        ...
                        <div class="card-body">
                               <ul class="card-info">
                               <li><h4 class="card-text"><?php echo $row["prod_name"]; ?></h4></li> 
                               <li><h4 class="card-text"><?php echo $row["prod_color"]; ?></h4></li>
                               <li><h4 class="card-text"><?php echo $row["seller_id"]; ?></h4> </li>
                               </ul>
                               <hr>
