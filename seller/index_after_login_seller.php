      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="index_after_login_seller.php">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " aria-current="page" href="all_product_after_login_seller.php">Products</a>
            </li>
